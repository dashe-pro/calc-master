...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const calculators = ['mortgage', 'bmi', 'discount', 'tip', 'compound', 'date', 'due-date', 'baby-growth']
  const devTools = ['json-formatter', 'timestamp-converter', 'base64-encoder', 'url-encoder', 'regex-tester', 'code-formatter', 'text-diff', 'qr-generator']
